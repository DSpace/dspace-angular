...
describe('Collection Statistics Page', () => {
  const COLLECTIONSTATISTICSPAGE = '/statistics/collections/'.concat(Cypress.expose('DSPACE_TEST_COLLECTION'));
  ...
  it('should contain a "Total visits per month" section', () => {
    ...
    cy.get('.'.concat(Cypress.expose('DSPACE_TEST_COLLECTION')).concat('_TotalVisitsPerMonth')).should('exist');
  });
