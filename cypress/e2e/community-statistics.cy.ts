...
describe('Community Statistics Page', () => {
  const COMMUNITYSTATISTICSPAGE = '/statistics/communities/'.concat(Cypress.expose('DSPACE_TEST_COMMUNITY'));
  ...
  it('should contain a "Total visits per month" section', () => {
    ...
    cy.get('.'.concat(Cypress.expose('DSPACE_TEST_COMMUNITY')).concat('_TotalVisitsPerMonth')).should('exist');
  });
