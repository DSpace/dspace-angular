...
export class ThemeConfig extends Config implements NamedThemeConfig, RegExThemeConfig, HandleThemeConfig, UUIDThemeConfig {
  @Config.public name: string;
  @Config.public extends?: string;
  @Config.public headTags?: HeadTagConfig[];
  @Config.public regex: string;
  @Config.public handle: string;
  @Config.public uuid: string;
}
