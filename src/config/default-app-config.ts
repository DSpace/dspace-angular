...
export class DefaultAppConfig implements AppConfig {
  ...
  languages: LangConfig[] = [
    ...
    { code: 'as', label: 'অসমীয়া', active: true },
    ...
    { code: 'kn', label: 'ಕನ್ನಡ', active: true },
    { code: 'ko', label: 'कोंकणी', active: true },
    { code: 'ks', label: 'كشمیری', active: true },
    ...
    { code: 'ur', label: 'اردو', active: true },
