...
describe('DuplicateMatchComponent test suite', () => {
  ...
  describe('', () => {
    beforeEach(() => {
      ...
      comp.rejectForm = compAsAny.formBuilder.group({
        reason: ['Dummy Reason']
      });
    ...
    it('dispatchAction, in setAsDuplicate should be called with \'verify\', and \'WORKFLOW\'', () => {
      const decision = new DuplicateDecision(
        'verify',
        DuplicateDecisionType.WORKFLOW,
        '');
      compAsAny.submissionService.getSubmissionScope.and.returnValue(SubmissionScopeType.WorkflowItem);
      comp.match = matchWorkflowMock;
    ...
    it('dispatchAction, in setAsNotDuplicate, should be called with \'reject\', and \'WORKFLOW\'', () => {
      const decision = new DuplicateDecision(
        'reject',
        DuplicateDecisionType.WORKFLOW);
      compAsAny.submissionService.getSubmissionScope.and.returnValue(SubmissionScopeType.WorkflowItem);
