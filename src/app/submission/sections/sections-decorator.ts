...
} from './cc-license/submission-section-cc-licenses.component';
...
} from './section-coar-notify/section-coar-notify.component';
import {
  SubmissionSectionSherpaPoliciesComponent,
} from './sherpa-policies/section-sherpa-policies.component';
