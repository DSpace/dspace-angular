...
var NormalizedObjectFactory = /** @class */ (function () {
    function NormalizedObjectFactory() {
    }
    NormalizedObjectFactory.getConstructor = function (type) {
        switch (type) {
    ...
    return NormalizedObjectFactory;
}());
export { NormalizedObjectFactory };
//# sourceMappingURL=normalized-object-factory.js.map