...
export const tabPersonProfile: DynamicLayoutTab = {
  type: TAB,
  id: 1,
...
export const tabPersonBiography: DynamicLayoutTab = {
  type: TAB,
  id: 2,
...
export const tabPersonBibliometrics: DynamicLayoutTab = {
  type: TAB,
  id: 3,
...
export const tabPersonTest: DynamicLayoutTab = {
  type: TAB,
  id: 4,
...
export const leadingTabs: DynamicLayoutTab[] = [
  Object.assign(new DynamicLayoutTab(), {
    'id': 1,
    'shortname': 'info',
    'header': 'Profile',
    'entityType': 'Person',
...
export const loaderTabs: DynamicLayoutTab[] = [Object.assign(new DynamicLayoutTab(), {
  'id': 2,
  'shortname': 'info',
  'header': 'Profile',
  'entityType': 'Person',
...
export const loaderMultilevelTabs: DynamicLayoutTab[] = [
  Object.assign(new DynamicLayoutTab(), {
    'id': 2,
    'shortname': 'info',
    'header': 'Profile',
...
export const tabDetailsTest: DynamicLayoutTab = {
  'id': 395,
  'shortname': 'details',
  'header': 'Informations',
  'entityType': 'OrgUnit',
...
export const tabPublicationsTest: DynamicLayoutTab = {
  'id': 396,
...
export const tabRpPublicationsTest: DynamicLayoutTab = {
  'id': 397,
...
export const tabProjectsTest: DynamicLayoutTab = {
  'id': 398,
  'shortname': 'projects',
  'header': 'Projects',
  'entityType': 'OrgUnit',
...
export const tabRpProjectsTest: DynamicLayoutTab = {
  'id': 399,
...
export const tabPeoplesTest: DynamicLayoutTab = {
  'id': 400,
  'shortname': 'people',
  'header': 'Peoples',
  'entityType': 'OrgUnit',
...
export const tabFundingsTest: DynamicLayoutTab = {
  'id': 395,
