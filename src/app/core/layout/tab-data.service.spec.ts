...
import { DynamicLayoutTab } from './models/tab.model';
...
describe('TabDataService', () => {
  ...
  const tabPersonProfile: DynamicLayoutTab = {
    type: TAB,
    id: 1,
  ...
  const tabPersonBiography: DynamicLayoutTab = {
    type: TAB,
    id: 2,
  ...
  const tabWithOnlyMinors: DynamicLayoutTab = {
    type: TAB,
    id: 4,
    shortname: 'person-bibliometrics',
    header: 'person-bibliometrics-header',
  ...
  const tabWithSomeMinors: DynamicLayoutTab = {
    type: TAB,
    id: 5,
    shortname: 'person-bibliometrics',
    header: 'person-bibliometrics-header',
  ...
  describe('findById', () => {
    ...
    it('should return a RemoteData<DynamicLayoutTab> for the object with the given id', () => {
  ...
  describe('searchByItem', () => {
    ...
    it('should return a RemoteData<PaginatedList<DynamicLayoutTab>> for the search', () => {
