...
@listableObjectComponent('IIIFSearchableResult', ViewMode.ListElement)
@Component({
 ...
 */
export class IIIFSearchableResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
}
