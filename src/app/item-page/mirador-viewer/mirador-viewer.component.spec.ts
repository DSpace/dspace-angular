// CLARIN
// These tests are occasionally failing, because of this error:
// Failed: NG0904: unsafe value used in a resource URL context (see https://g.co/ng/security#xss)
// Every time another tests are failed...
