 ...
 */
export function searchResultFor(domainConstructor, configuration) {
    if (configuration === void 0) { configuration = null; }
    return function decorator(searchResult) {
        if (!searchResult) {
            return;
        }
 ...
 */
export function getSearchResultFor(domainConstructor, configuration) {
    if (configuration === void 0) { configuration = null; }
...
//# sourceMappingURL=search-result-element-decorator.js.map