...
import { LogOutAction, RefreshStateTokenRedirectAction } from '../../core/auth/auth.actions';
      ...
      describe('submit', () => {
        describe('when accepting the agreement was successful', () => {
          ...
          it('should refresh the token and navigate the user to the redirect url', () => {
            expect(store.dispatch).toHaveBeenCalledWith(new RefreshStateTokenRedirectAction(token, redirectUrl));
          });
        });
