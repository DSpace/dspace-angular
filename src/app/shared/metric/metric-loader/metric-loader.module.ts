import { MetricRowComponent } from './../../../cris-layout/cris-layout-matrix/cris-layout-box-container/boxes/metrics/metric-row/metric-row.component';
...
export class MetricLoaderModule { }
