...
export var mockSectionsDataTwo = {
    traditionalpageone: {
        'dc.title': [
            new FormFieldMetadataValueObject('test', null, null, 'test')
        ]
...
export var mockUploadResponse1Errors = {
    errors: [
        {
            message: 'error.validation.required',
            paths: [
...
export var mockUploadResponse1ParsedErrors = {
    traditionalpageone: [
...
export var mockLicenseParsedErrors = {
    license: [
        { path: '/sections/license', message: 'error.validation.license.notgranted' }
    ]
};
export var mockUploadResponse2Errors = {
    errors: [
        {
            message: 'error.validation.required',
            paths: [
...
export var mockUploadResponse2ParsedErrors = {
    traditionalpageone: [
        { path: '/sections/traditionalpageone/dc.title', message: 'error.validation.required' },
        { path: '/sections/traditionalpageone/dc.date.issued', message: 'error.validation.required' }
    ],
...
export var mockSubmissionRestResponse = [
    {
        id: 826,
...
export var mockSubmissionObject = {
    collection: {
        handle: '10673/2',
        license: 'https://rest.api/dspace-spring-rest/api/core/collections/1c11f3f1-ba1f-4f36-908a-3f1ea9a557eb/license',
        defaultAccessConditions: {
...
export var mockSubmissionObjectNew = {
    collection: {
        handle: '10673/2',
...
export var mockSubmissionCollectionId = '1c11f3f1-ba1f-4f36-908a-3f1ea9a557eb';
export var mockSubmissionId = '826';
export var mockSubmissionSelfUrl = 'https://rest.api/dspace-spring-rest/api/submission/workspaceitems/826';
export var mockSubmissionDefinitionResponse = {
    isDefault: true,
    sections: [
        {
            mandatory: true,
...
export var mockSubmissionDefinition = {
    isDefault: true,
...
export var mockSectionsState = Object.assign({}, {
    extraction: {
        config: '',
        mandatory: true,
        sectionType: 'utils',
...
export var mockUploadConfigResponse = {
...
export var mockAccessConditionOptions = [
    {
        name: 'openaccess',
        groupUUID: '123456-g',
        hasStartDate: false,
...
export var mockGroup = Object.assign(new Group(), {
    handle: null,
    permanent: true,
...
//# sourceMappingURL=mock-submission.js.map