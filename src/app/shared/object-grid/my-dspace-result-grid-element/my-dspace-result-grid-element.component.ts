...
@Component({
  selector: 'ds-my-dspace-result-grid-element',
  template: ``
})

export class MyDSpaceResultGridElementComponent<T extends MyDSpaceResult<K>, K extends SubmissionObject> extends AbstractListableElementComponent<T> {
  dso: K;
