...
describe('DsoPublicMenuSectionComponent', () => {
  let component: DsoPublicMenuSectionComponent;
  let fixture: ComponentFixture<DsoPublicMenuSectionComponent>;
