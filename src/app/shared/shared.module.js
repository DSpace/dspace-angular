...
var SHARED_ITEM_PAGE_COMPONENTS = [
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = tslib_1.__decorate([
        NgModule({
            imports: MODULES.concat(ROOT_MODULES),
            declarations: PIPES.concat(COMPONENTS, DIRECTIVES, ENTRY_COMPONENTS, SHARED_ITEM_PAGE_COMPONENTS),
            providers: PROVIDERS.slice(),
            exports: MODULES.concat(PIPES, COMPONENTS, SHARED_ITEM_PAGE_COMPONENTS, DIRECTIVES),
