...
import { BrowseByConfig } from '../../modules/core/src/lib/core/config/browse-by-config.interface';
import { BundleConfig } from '../../modules/core/src/lib/core/config/bundle-config.interface';
import { CacheConfig } from '../../modules/core/src/lib/core/config/cache-config.interface';
import { CollectionPageConfig } from '../../modules/core/src/lib/core/config/collection-page-config.interface';
import { CommunityListConfig } from '../../modules/core/src/lib/core/config/community-list-config.interface';
import { CommunityPageConfig } from '../../modules/core/src/lib/core/config/community-page-config.interface';
import { DiscoverySortConfig } from '../../modules/core/src/lib/core/config/discovery-sort.config';
import { FilterVocabularyConfig } from '../../modules/core/src/lib/core/config/filter-vocabulary-config';
import { FormConfig } from '../../modules/core/src/lib/core/config/form-config.interfaces';
import { HomeConfig } from '../../modules/core/src/lib/core/config/homepage-config.interface';
import { InfoConfig } from '../../modules/core/src/lib/core/config/info-config.interface';
import { ItemConfig } from '../../modules/core/src/lib/core/config/item-config.interface';
import { LangConfig } from '../../modules/core/src/lib/core/config/lang-config.interface';
import { LiveRegionConfig } from '../../modules/core/src/lib/core/config/live-region.config';
import { MarkdownConfig } from '../../modules/core/src/lib/core/config/markdown-config.interface';
...
import { QualityAssuranceConfig } from '../../modules/core/src/lib/core/config/quality-assurance.config';
import { SearchPageConfig } from '../../modules/core/src/lib/core/config/search-page-config.interface';
import { ServerConfig } from '../../modules/core/src/lib/core/config/server-config.interface';
import { SubmissionConfig } from '../../modules/core/src/lib/core/config/submission-config.interface';
