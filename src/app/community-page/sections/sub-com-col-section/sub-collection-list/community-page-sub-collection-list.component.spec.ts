...
describe('CommunityPageSubCollectionListComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    }).overrideComponent(CommunityPageSubCollectionListComponent, { remove: { imports: [ObjectCollectionComponent, ErrorComponent, ThemedLoadingComponent] } }).compileComponents();
  }));
