...
@Component({
  selector: 'app-cancel-trip-details',
  templateUrl: './cancel-trip-details.component.html',
  styleUrls: ['./cancel-trip-details.component.scss']
})
export class CancelTripDetailsComponent {
  isChecked:true;
