...
// @ts-ignore
import { NotificationsResponse } from '../interfaces/notifications-response';
...
export class NotificationsApiService {
    ...
    public notificationsGet(pageNumber: number, noOfRecordsPerPage: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (pageNumber === null || pageNumber === undefined) {
            throw new Error('Required parameter pageNumber was null or undefined when calling notificationsGet.');
        }
        if (noOfRecordsPerPage === null || noOfRecordsPerPage === undefined) {
            throw new Error('Required parameter noOfRecordsPerPage was null or undefined when calling notificationsGet.');
        }
        ...
        return this.httpClient.request<NotificationsResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
