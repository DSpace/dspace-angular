...
// @ts-ignore
import { SubcategoryResponse } from '../interfaces/subcategory-response';
...
export class CategoryApiService {
    ...
    public categoryListGet(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/category/list`;
        return this.httpClient.request<CategoryResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
    ...
    public categorySubCategoryGet(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        let localVarPath = `/category/sub_category`;
        return this.httpClient.request<SubcategoryResponse>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
