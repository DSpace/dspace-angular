...
var MyDSpacePageModule = /** @class */ (function () {
    /**
     * This module handles all components that are necessary for the mydspace page
     */
    function MyDSpacePageModule() {
    }
    MyDSpacePageModule = tslib_1.__decorate([
        NgModule({
            imports: [
                CommonModule,
                SharedModule,
    ...
    return MyDSpacePageModule;
}());
export { MyDSpacePageModule };
//# sourceMappingURL=my-dspace-page.module.js.map