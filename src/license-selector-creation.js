  ...
  $('<a #xD id="license-text"">OPEN License Selector</a>').appendTo('body').licenseSelector({
    licenses: {
      'pcedt2': {
        ...
        available: true,
        url: 'https://lindat.mff.cuni.cz/repository/static/license-pcedt2',
      ...
      'cnc': {
        ...
        available: true,
        url: 'https://lindat.mff.cuni.cz/repository/static/license-cnc',
      ...
      'hamledt': {
        ...
        available: true,
        url: 'https://lindat.mff.cuni.cz/repository/static/licence-hamledt',
      ...
      'hamledt-2.0': {
        ...
        available: false,
        url: 'https://lindat.mff.cuni.cz/repository/static/licence-hamledt-2.0',
      ...
      'pdt2': {
        ...
        available: true,
        url: 'https://lindat.mff.cuni.cz/repository/static/license-pdt2',
      ...
      'pdtsl': {
        name: 'PDTSL',
        available: true,
        url: 'https://lindat.mff.cuni.cz/repository/static/licence-pdtsl',
