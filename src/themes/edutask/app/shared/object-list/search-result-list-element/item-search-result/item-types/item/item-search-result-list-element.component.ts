...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'edutask')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'edutask')
@Component({
