...
export var REQ_KEY = makeStateKey('req');
...
var BrowserAppModule = /** @class */ (function () {
    function BrowserAppModule(transferState) {
        this.transferState = transferState;
        this.transferState.transfer();
    }
    BrowserAppModule = tslib_1.__decorate([
        NgModule({
...
//# sourceMappingURL=browser-app.module.js.map