...
import { APP_CONFIG, UUIDService } from '@dspace/core';
...
export class LiveRegionService {
   ...
   * @protected
   */
  protected messageTimeOutDurationMs: number = this.appConfig.liveRegion.messageTimeOutDurationMs;
   ...
   * @protected
   */
  protected liveRegionIsVisible: boolean = this.appConfig.liveRegion.isVisible;
