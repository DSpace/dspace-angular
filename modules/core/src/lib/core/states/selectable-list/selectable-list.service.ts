...
//TODO: reintroduce interface for appState and remove duplicated keySelector function
function keySelector<T>(key: string, selector): MemoizedSelector<any, T> {
...
const selectableListsStateSelector = (state: any) => state.selectableLists;

const menuByIDSelector = (id: string): MemoizedSelector<any, SelectableListState> => {
