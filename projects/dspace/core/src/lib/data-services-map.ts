...
} from './notifications/qa/models/quality-assurance-event-object.resource-type';
import {
  QUALITY_ASSURANCE_SOURCE_OBJECT,
} from './notifications/qa/models/quality-assurance-source-object.resource-type';
import {
  QUALITY_ASSURANCE_TOPIC_OBJECT,
} from './notifications/qa/models/quality-assurance-topic-object.resource-type';
import { SUGGESTION } from './notifications/suggestions/models/suggestion-objects.resource-type';
import {
  SUGGESTION_SOURCE,
} from './notifications/suggestions/models/suggestion-source-object.resource-type';
import {
  SUGGESTION_TARGET,
} from './notifications/suggestions/models/suggestion-target-object.resource-type';
...
} from './submission/models/submission-cc-licence-link.resource-type';
import {
  VOCABULARY,
  VOCABULARY_ENTRY,
