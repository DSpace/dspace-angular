...
import { hasValue, isNotEmpty, isNotEmptyOperator } from '@dspace/utils';
import { AsyncSubject, from as observableFrom, Observable, of, shareReplay } from 'rxjs';
import { map, mergeMap, skipWhile, switchMap, take, tap, toArray } from 'rxjs/operators';

import { getLinkDefinition, LinkDefinition } from '../../cache/builders/build-decorators';
