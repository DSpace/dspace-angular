...
import { hasValue, hasValueOperator, isNotEmpty, isNotEmptyOperator } from '@dspace/utils';
...
import { followLink, FollowLinkConfig } from '../shared/follow-link-config.model';
...
} from '../shared/metadata-representation/item/item-metadata-representation.model';
import {
  MetadataRepresentation,
} from '../shared/metadata-representation/metadata-representation.model';
import {
  MetadatumRepresentation,
} from '../shared/metadata-representation/metadatum/metadatum-representation.model';
